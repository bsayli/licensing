...
public class SignatureGenerator {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("Generated Signature for the encLicenseKey: " + signature);

		signatureData = getSignatureDataWithLicenseToken();
		signature = createSignature(signatureData);
		System.out.println("Generated Signature for the licenseToken: " + signature);
	}

	public static SignatureData getSignatureDataWithLicenseKey() throws Exception {
		String serviceId = "c9ineCodegen";
		String serviceVersion = "1.2.2";
		String encryptedLicenseKey = "v6ZFWUUUDlVaONpVJzzDowezuCkCk6szc4ClvB0ow6V+oyuY2bsJCPdVQErI0F7jiJ44X9xoyRCrMN2Ugz2iK1kekvRkHQdaxREMz8NnQCCIodstpdYqSv+h1lNJqROPzfvj23TxHBSKr0PzlS/OoqulJuHb0rU+9WR/LoAFAr5/L740bToGooZ/KLRKKeGOS3LCJfOApMCVvL9YblYxwPPLTOZC2A==";
		...
		return new SignatureData.Builder()
				...
				.encryptedLicenseKeyHash(encryptedLicenseKeyHash).build();
	}

	public static SignatureData getSignatureDataWithLicenseToken() throws Exception {
		String serviceId = "c9ineCodegen";
		String serviceVersion = "1.2.2";
		String token = "eyJhbGciOiJFZERTQSJ9.eyJzdWIiOiJjOWluZUNvZGVnZW5-bWFjYm9va3V5bmprbDV-MDA6MkE6OEQ6QkU6RjE6MjMiLCJsaWNlbnNlU3RhdHVzIjoiQWN0aXZlIiwibGljZW5zZVRpZXIiOiJQcm9mZXNzaW9uYWwiLCJpYXQiOjE3MjIxNzY5MjEsImV4cCI6MTcyMjE3Njk4MX0.3Acy39GVi_S5CXUsnKDPmOBWpjD-UoOdfAkyB1QKlDxBuggR4nOhZvGFlNooMNB67f_bp_iySLPmXVPrXIHnDQ";
		...
		return new SignatureData.Builder()
				...
				.serviceVersion(serviceVersion)
				.instanceId(instanceId)
				.licenseTokenHash(tokenHash).build();
	}

	public static String createSignature(SignatureData signatureData) throws Exception {
