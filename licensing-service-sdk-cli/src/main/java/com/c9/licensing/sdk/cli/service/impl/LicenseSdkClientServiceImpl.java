...
public class LicenseSdkClientServiceImpl implements LicenseSdkClientService{
	...
	public Integer validateLicense(String instanceId, String licenseKey, String serviceId, String serviceVersion) {
		...
		Request postRequest = buildPostRequest(endpointUrl, instanceId, licenseKey, serviceId, serviceVersion);
	...
	private Request buildPostRequest(String endpointUrl, String instanceId, String licenseKey, String serviceId, String serviceVersion) {
		return Request.post(endpointUrl)
				...
				.setHeader(HttpHeaders.AUTHORIZATION, createBasicAuthHeader(clientProperties.appUser(), clientProperties.appPass()))
	...
	private String getPrettyJsonStr(ObjectMapper mapper, LicenseValidationResponse errorResponse) {
		...
		try {
			licenseErrorResponsePrettyStr = mapper.writerWithDefaultPrettyPrinter()
