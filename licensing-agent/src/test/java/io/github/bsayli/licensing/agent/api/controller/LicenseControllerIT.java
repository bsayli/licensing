...
import io.github.bsayli.licensing.agent.api.exception.LicenseControllerAdvice;
...
import io.github.bsayli.licensing.agent.testconfig.TestRestClientConfig;
...
@WebMvcTest(
        ...
        excludeFilters = {
                @ComponentScan.Filter(
                        ...
                        classes = io.github.bsayli.licensing.agent.config.security.SecurityConfig.class),
                @ComponentScan.Filter(
