...
class LicenseValidationServiceImplTest {
    ...
    @Mock
    private LicenseEvaluationService licenseEvaluationService;
    @Mock
    private TokenRequestValidator tokenValidationService;
    @Mock
    private LicenseKeyRequestValidator licenseKeyValidationService;
    @Mock
    private UserIdEncryptor userIdEncryptor;

    @InjectMocks
    private LicenseValidationServiceImpl service;
