...
public class LicenseKeyRequestValidationServiceImpl implements LicenseKeyRequestValidationService {
  ...
  @Override
  public void validateSignature(IssueTokenRequest request) {
    signatureValidator.validate(request);
  }

  @Override
  public void assertNotCachedWithSameContext(IssueTokenRequest request, String userId) {
    String clientId = clientIdGenerator.getClientId(request);
    Optional<ClientCachedLicenseData> cachedOpt =
