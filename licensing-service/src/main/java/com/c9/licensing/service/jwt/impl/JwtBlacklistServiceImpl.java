...
public class JwtBlacklistServiceImpl implements JwtBlacklistService {
	...
	public JwtBlacklistServiceImpl(LicenseClientCacheManagementService clientCacheManagementService,
	...
	public void addCurrentTokenToBlacklist(String clientId) {
		Optional<ClientCachedLicenseData> cachedData = clientCacheManagementService
				.getClientCachedLicenseData(clientId);
