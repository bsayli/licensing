...
public class LicenseValidationServiceImpl implements LicenseValidationService{
	...
	private UserOrchestrationService userService;

	public LicenseValidationServiceImpl(EncryptionUtil encryptionUtil, UserIdUtil userIdUtil, UserOrchestrationService userService) {
