...
public class TokenValidationService {
	...
	private static final String ERROR_DURING_TOKEN_VALIDATION = "An unexpected error occurred during token validation";
	private static final String TOKEN_INVALID = "Token invalid!";
	private static final String TOKEN_INVALID_ACCESS = "Token invalid access!";
