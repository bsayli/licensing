...
public class UserIdEncrypter {
  ...
  private static final Logger logger = LoggerFactory.getLogger(UserIdEncrypter.class);
  ...
  public static void main(String[] args) throws Exception {
    ...
    logger.info("Enc User Id: {}", userIdEncrypt);

    String userIdDecrypt = decrypt(userIdEncrypt);
    logger.info("Dec User Id: {}", userIdDecrypt);
  }
