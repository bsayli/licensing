...
public class SignatureGeneratorImpl implements SignatureGenerator {
	...
	public String generateSignature(LicenseServerValidationRequest request){
		Builder builder = new SignatureData.Builder()
	...
	private String createSignature(SignatureData signatureData) throws JsonProcessingException, InvalidKeyException, NoSuchAlgorithmException, SignatureException {
