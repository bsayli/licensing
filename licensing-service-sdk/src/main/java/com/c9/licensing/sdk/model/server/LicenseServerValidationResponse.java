...
public record LicenseServerValidationResponse(boolean success, String status, String message, String licenseToken, List<String> errorDetails) implements Serializable {
	...
	public static class Builder {
		...
		public LicenseServerValidationResponse build() {
			...
			return new LicenseServerValidationResponse(success, status, message, licenseToken, errorDetails);
		}
	}
}